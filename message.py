...
class Phermone_message(Message):
    ...
    def __init__(self, sent_by, received_by, phermone_dict:dict, timestamp: Timestamp) -> None:
...
class Agreement_message(Message):
    ...
    def __init__(self, sent_by, received_by,timestamp:Timestamp, solution, profit) -> None:
        super().__init__(sent_by, received_by, timestamp=timestamp)
